...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.course.observe(this) {detailCourse ->
            showCourseDetail(detailCourse)
        }
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val setClock = getString(R.string.time_format)
            val setDay = getByNumber(day)
            val setTime = String.format(setClock, setDay, startTime, endTime)

            findViewById<TextView>(R.id.tv_time).text = setTime
