...
class DataRepository(private val dao: CourseDao) {
    ...
    fun getNearestSchedule(queryType: QueryType) : LiveData<Course?> {
        ...
        val nearestSchedule = nearestQuery(queryType)
        return dao.getNearestSchedule(nearestSchedule)
...
//        throw NotImplementedError("needs implementation")
    ...
    fun getAllCourse(sortType: SortType): LiveData<PagedList<Course>> {
        ...
        val setSortType = dao.getAll(sortType)

        val dataConfig = PagedList.Config.Builder().setPageSize(PAGE_SIZE).build()

        return LivePagedListBuilder(setSortType, dataConfig).build()
//        throw NotImplementedError("needs implementation")
    }
...
//        throw NotImplementedError("needs implementation")
    ...
    fun getTodaySchedule() : List<Course> {
        ...
        val getTodaySchedule = Calendar.getInstance().get(Calendar.DAY_OF_WEEK)

        return dao.getTodaySchedule(getTodaySchedule)
